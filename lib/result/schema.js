...
module.exports = {
    ...
    , 801: () => {
        return {
            ...
            result: { code: 801, message: 'upstream timeout', data: null }
        };
    }
    , 802: () => {
        return {
            ...
            result: { code: 802, message: 'upstream refused', data: null }
        };
    }
    , 803: () => {
        return {
            code: 803,
            grade: 'FATAL',
            message: `upstream mistake`,
            result: { code: 803, message: 'upstream mistake', data: null }
        };
    }
    , 804: ({ data = 500 }) => {
        return {
            code: 804,
            grade: 'FATAL',
            message: `upstream return ${data}`,
            result: { code: 804, message: `upstream return ${data}`, data: null }
        };
    }
